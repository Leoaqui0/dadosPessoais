...
export default function Form(){
    ...
    const[telefone, setTelefone]=useState(null) // estado para armazenar o peso
    ...
    function dadosCalculator(){
        return setDados((nome +" enviaremos atualizações no seu telefone " + telefone + " ou " + email))
    }
    ...
    setMessageDados("PREENCHA NOME, TELEFONE E EMAIL PARA Concluir!")
    }
    ...
    return(
        ...
        <TextInput style={styles.input} onChangeText={setNome} value={nome}placeholder="Ex: Carol" keyboardType="default"/>
        
        <Text style={styles.formLabel}>Telefone</Text>
        <TextInput style={styles.input} onChangeText={setTelefone} value={telefone} placeholder="Ex: (11) 99999-9999" keyboardType="number-pad"/>
